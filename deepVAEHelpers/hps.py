...
cifar10.zdim = 16
cifar10.wd = 0.01
cifar10.dec_blocks = "1x1,4m1,4x2,8m4,8x5,16m8,16x11,32m16,32x22"
cifar10.enc_blocks = "32x6,32d2,16x6,16d2,8x6,8d2,4x6,4d4,1x7"
cifar10.adam_warmup_iters = 100
...
i32.enc_blocks = "32x9,32d2,16x9,16d2,8x9,8d2,4x9,4d4,1x10"
i32.width = 512
i32.n_batch = 8
i32.lr = 0.00015
i32.grad_clip = 110.0
i32.skip_threshold = 150.0
i32.epochs_per_eval = 1
i32.epochs_per_eval_save = 1
HPARAMS_REGISTRY["i32"] = i32

i64 = Hyperparams()
i64.update(i32)
i64.n_batch = 4
i64.grad_clip = 180.0
i64.skip_threshold = 300.0
i64.dataset = "imagenet64"
i64.dec_blocks = "1x2,4m1,4x3,8m4,8x7,16m8,16x15,32m16,32x31,64m32,64x12"
i64.enc_blocks = "64x9,64d2,32x9,32d2,16x9,16d2,8x9,8d2,4x9,4d4,1x10"
HPARAMS_REGISTRY["i64"] = i64
...
ffhq_256.dec_blocks = "1x2,4m1,4x3,8m4,8x4,16m8,16x9,32m16,32x20,64m32,64x12,128m64,128x6,256m128"
ffhq_256.enc_blocks = "256x1,256d2,128x4,128d2,64x7,64d2,32x7,32d2,16x7,16d2,8x7,8d2,4x7,4d4,1x8"
ffhq_256.no_bias_above = 64
ffhq_256.grad_clip = 40
ffhq_256.skip_threshold = 80
HPARAMS_REGISTRY["ffhq_256"] = ffhq_256
...
ffhq1024.grad_clip = 220.0
ffhq1024.skip_threshold = 260.0
ffhq1024.num_mixtures = 5
ffhq1024.width = 8
ffhq1024.dec_blocks = "1x2,4m1,4x3,8m4,8x4,16m8,16x9,32m16,32x20,64m32,64x12,128m64,128x8,256m128,256x4,512m256,512x2,1024m512"
ffhq1024.enc_blocks = "1024x2,1024d2,512x3,512d2,256x6,256d2,128x7,128d2,64x7,64d2,32x7,32d2,16x7,16d2,8x7,8d2,4x7,4d4,1x8"
ffhq1024.custom_width_str = "512:16,256:64,128:256,64:512,32:512,16:512,8:512,4:512,1:512"
HPARAMS_REGISTRY["ffhq_1024"] = ffhq1024
...
def add_vae_arguments(parser):
    ...
    parser.add_argument("--save_dir", type=str, default="./my_saved_vaes")
    ...
    parser.add_argument("--directly_train_prior_posterior", action="store_true")

    parser.add_argument("--num_mixtures", type=int, default=10)
    parser.add_argument("--adam_warmup_iters", type=float, default=0)
